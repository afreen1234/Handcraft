...
namespace Handcraft.Helpers
{
    public static class HtmlHelper
    {
        ...
        private static Func<MenuItem, HelperResult> GetDefaultItemTemplate(System.Web.Mvc.HtmlHelper helper)
        {
        ...
        /// </summary>
        public static ConditionalLink BeginConditionalLink(this System.Web.Mvc.HtmlHelper helper, bool shouldWriteLink, IHtmlString url, string title = null, string cssClass = null)
        {
            if (shouldWriteLink)
            {
        ...
        /// </remarks>
        public static ConditionalLink BeginConditionalLink(this System.Web.Mvc.HtmlHelper helper, bool shouldWriteLink, Func<IHtmlString> urlGetter, string title = null, string cssClass = null)
        {
